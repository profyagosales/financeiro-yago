          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'center', flex: 1, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 12, color: '#9B7B6A', marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {invest.nome}{invest.ticker ? ` · ${invest.ticker}` : ''} · {isVar ? `${qtdMaxima.toLocaleString('pt-BR')} ${invest.tipo === 'Cripto' ? 'unid.' : 'cotas'} em estoque` : `${simbolo} ${invest.valorAtual.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} disponível`}
              </p>
            </div>
          </div>
